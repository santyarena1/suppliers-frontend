...
- **Estado**: IMPLEMENTADO
- **Notas**: Un carrito por comercio, no por persona. `VIEWER` puede GET, no muta. El superadmin de prueba tiene carrito propio; credenciales y vínculos los lee del Comercio de Pruebas.
