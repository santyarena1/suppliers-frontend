...
| 5 | Tipo 1 autónomo: el dueño arma su equipo, canjea códigos y carga el contacto, sin pasar por el superadmin. Alta self-serve: onboarding crea la org + plan FREE + demo. | Hecho — `docs/PLAN_ONBOARDING.md` |
