/** Lo que el portal de New Bytes manda por comprobante y usa este resumen. */
export type NbComprobanteLike = {
  invoiceType?: string;
  invoiceLabel?: string;
  totalUsd?: number;
  perceptions?: number;
 ...
 */
function isCreditNote(row: NbComprobanteLike): boolean {
 ...
 */
export function nbCtaSummary(rows: NbComprobanteLike[]): NbCtaSummary | null {
